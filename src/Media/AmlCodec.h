...
class AmlCodec
{
	...
	void InternalOpen(VideoFormatEnum format, int width, int height, double frameRate, bool hasAudioSync);
	void InternalClose();
...
public:
	...
	void Open(VideoFormatEnum format, int width, int height, double frameRate, bool hasAudio);
	void Close();
	void Reset();
