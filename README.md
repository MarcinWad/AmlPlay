...
    - reconstructed video\_buffer for end of stream instead of wrong PTS calculations in small files or video-only files  
...
Warning!  
AVS2 support is broken in 5.4.180 media\_modules Amlogic kernel modules! Need the 5.4.120 or kernel 5.4.120.
